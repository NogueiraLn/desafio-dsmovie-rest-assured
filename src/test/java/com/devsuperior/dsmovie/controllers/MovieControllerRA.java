...
public class MovieControllerRA {
	...
	public void findAllShouldReturnOkWhenMovieNoArgumentsGiven() {
		...
		given()
				...
				.then()
				.statusCode(200)
				.body("content.id[7]", is(8))
				.body("content.title[7]", is("O Lobo de Wall Street"))
				.body("content.score[7]", is(0.0F))
				.body("content.count[7]", is(0))
				.body("content.image[7]", equalTo("https://www.themoviedb.org/t/p/w533_and_h300_bestv2/cWUOv3H7YFwvKeaQhoAQTLLpo9Z.jpg"));
	}
